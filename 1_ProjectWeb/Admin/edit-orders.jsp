                                            ...
                                            <div class="tab-pane show active" id="basic-form-preview">
                                                <form>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="#BMxxxx">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-floating">
                                                            <select class="form-select" id="floatingSelect">
                                                                <option selected> Đã trả</option>
                                                                <option value="1"> Đang xác thực</option>
                                                                <option value="2"> Thất bại</option>
                                                            </select>
                                                            <label for="floatingSelect">Chọn tình trạng thanh toán của đơn hàng</label>
                                                        </div>
                                                    </div>
                                                    
                                                    <div class="mb-3">
                                                        <label class="form-label">Tổng tiền</label>
                                                        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Tổng tiền">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Điện thoại</label>
                                                        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Điện thoại">
                                                    </div>
                                                    <div class="mb-3">
