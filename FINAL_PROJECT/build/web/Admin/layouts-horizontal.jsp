...
<!-- Mirrored from coderthemes.com/hyper/saas/layouts-horizontal.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Dec 2023 13:30:21 GMT -->
<head>
        <meta charset="utf-8" />
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-dashboards" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="uil-dashboard"></i>Bảng điều khiển <div class="arrow-down"></div>
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="uil-apps"></i>Ứng dụng <div class="arrow-down"></div>
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                        <a href="calendar.jsp" class="dropdown-item">Lịch trình</a>
                                        <a href="chat.jsp" class="dropdown-item">Chat</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layouts" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="uil-window"></i>Quản lý sản phẩm <div class="arrow-down"></div>
                                    </a>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Sản Phẩm</h5>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-muted fw-normal mt-0" title="Growth">Báo Cáo</h5>
                        ...
                        <div id="layout-width">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4" id="layout-boxed">
                                    ...
                                    <h5 class="font-14 text-center text-muted mt-2">Hộp</h5>
                                </div>
