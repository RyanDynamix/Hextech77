                                            ...
                                            <div class="tab-pane show active" id="basic-form-preview">
                                                <form>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Địa chỉ">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-floating">
                                                            ...
                                                            <label for="floatingSelect">Chọn trạng thái hoạt động của khách hàng</label>
                                                        </div>
                                                    </div>
