                                            ...
                                            <div class="tab-pane show active" id="basic-form-preview">
                                                <form>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Tên sản phẩm">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Giá">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Discount</label>
                                                        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Discount">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Danh mục</label>
                                                        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Danh mục">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    data-upload-preview-template="#uploadPreviewTemplate">
                                                        ...
                                                        <div class="dz-message needsclick">
                                                            ...
                                                            <h3>Nhấn hoặc thả ảnh vào đây để tải lên</h3>
                                                            <span class="text-muted font-13">File phải là PNG, JPG hoặc JPEG và
                                                                <strong>không</strong> nặng quá 20mb</span>
                                                        </div>
                                                    </form>
                                                    ...
                                                    <button type="submit" class="btn btn-primary">Tạo sẩn phẩm</button>
                                                    <br>
                                                    <br>
                                                </form>                                      
                                            </div> <!-- end preview-->
