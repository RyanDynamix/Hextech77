                                            ...
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-body fw-bold">#BM9708 </td>
                                                        <td>
                                                            August 05 2018 <small class="text-muted">10:29 PM</small>
                                                        </td>
                                                        <td>
                                                            <h5><span class="badge badge-success-lighten"><i class="mdi mdi-bitcoin"></i>Đã trả</span></h5>
                                                        </td>
                                                        <td>
                                                            200.000
                                                        </td>
                                                        ...
                                                        <td>
                                                            <h5><span class="badge badge-info-lighten">Shipping</span></h5>
                                                        </td>
                                                        <td>
                                                            <a href="orders-details.jsp" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                            <a href="edit-orders.jsp" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-body fw-bold">#BM9707 </td>
                                                        <td>August 04 2018 <small class="text-muted">08:18 AM</small></td>
                                                        <td>
                                                            <h5><span class="badge badge-warning-lighten"><i class="mdi mdi-timer-sand"></i>Đang xác thực</span></h5>
                                                        </td>
                                                        <td>
                                                            200.000
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-body fw-bold">#BM9705 </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-body fw-bold">#BM9704 </td>
                                                        <td>May 22 2018 <small class="text-muted">07:22 PM</small></td>
                                                        <td>
                                                            <h5><span class="badge badge-danger-lighten"><i class="mdi mdi-cancel"></i>Thất bại</span></h5>
                                                        </td>
                                                        <td>
                                                            200.000
                                                        </td>
